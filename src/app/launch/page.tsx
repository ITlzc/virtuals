        ...
        <div className='main-container'>
            ...
            <div className={`main-content ${styles.content}`}>
                ...
                <section className={styles.formSection}>
                    ...
                    <div className={styles.formGroup}>
                        <label>AI Agent/App Name *</label>
                        <input type="text" placeholder="Enter AI Agent/App name" maxLength={20} onChange={(e) => setName(e.target.value)} />
                        <span className={styles.optional}>{name.length}/20</span>
                    </div>

                    <div className={styles.formGroup}>
                        <label>AI Agent/App Symbol ($Ticker) *</label>
                        <input type="text" placeholder="Enter AI Agent/App symbol" maxLength={10} onChange={(e) => setTicker(e.target.value)} />
                        <span className={styles.optional}>{ticker.length}/10</span>
                    </div>

                    <div className={styles.formGroup}>
                        <label>AI Agent/App Description *</label>
                        <textarea placeholder="Enter AI Agent/App description" maxLength={256} onChange={(e) => setDescription(e.target.value)} ></textarea>
                ...
                <footer className={styles.footer}>
                    <p>
                        2024 AonPump. All rights reserved
                        <br />
